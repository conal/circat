...
import Circat.Circuit
  ( (:>), GenBusesT, CompS(..), compName, compOuts, circuitGraph, tagged
  , Width, PinId, Bus(..) )
...
outV :: GenBusesT a => String -> (a :> b) -> IO ()
outV cirName cir = 
